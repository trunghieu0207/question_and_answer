...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $question2->attachment_path=null;
        ...
        $question3->attachment_path=null;
        ...
        $question4->attachment_path=null;
