...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $question->attachment_path="public/files/Myfile.zip";
        ...
        $question2->attachment_path="public/files/Myfile.zip";
        ...
        $question3->attachment_path="public/files/Myfile.zip";
        ...
        $question4->attachment_path="public/files/Myfile.zip";
